...
image_BGR = cv2.imread('C:/Users/vaide/Desktop/YOLO-3-OpenCV/YOLO-3-OpenCV/car.jpeg')
...
print("STEP1")
with open('C:/Users/vaide/Desktop/YOLO-3-OpenCV/YOLO-3-OpenCV/coco.names') as f:
...
# # Check point
# print()
# print(layers_names_output)  # ['yolo_82', 'yolo_94', 'yolo_106'] to get response from feed forward pass
...
for result in output_from_network:
    ...
    for detected_objects in result:
        ...
        #here the first four are coordinates of the bounded box
        # and rest 80 no represnt probabilities to which these bounding boxes can belong to
        #varible scores contain all these probabilities
